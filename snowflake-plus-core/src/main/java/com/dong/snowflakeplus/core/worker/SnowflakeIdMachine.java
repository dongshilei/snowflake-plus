...
public class SnowflakeIdMachine {
     ...
     */
    public SnowflakeIdMachine(long machineId) {
        if (machineId > maxMachineId || machineId < 0) {
            throw new IllegalArgumentException(String.format("machine Id can't be greater than %d or less than 0", machineId));
        }
    ...
    public static void main(String[] args) {
        SnowflakeIdMachine idWorker = new SnowflakeIdMachine( 1);
